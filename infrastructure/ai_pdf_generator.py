...
class PropertyPDFGenerator:
    ...
    def generate_property_pdf(self, property_data: dict, output_path: str) -> str:
        ...
        try:
            ...
            pdf.set_font("Helvetica", "", 11)
            pdf.multi_cell(0, 7, property_data.get('description', 'Nessuna descrizione disponibile.'))
            ...
            logger.info("PDF_GENERATED", context={"path": output_path, "property": property_data.get('id')})
            return output_path
