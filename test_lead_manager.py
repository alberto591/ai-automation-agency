...
class TestLeadManager(unittest.TestCase):
    ...
    def test_get_property_details(self, mock_supabase):
        ...
        mock_response.data = [
            {"id": 1, "title": "Attico a Milano", "price": 500000, "city": "Milano"}
        ]
    ...
    def test_send_ai_whatsapp(self, mock_twilio, mock_mistral):
        ...
        mock_mistral_response.choices = [
            MagicMock(message=MagicMock(content="Test AI message"))
        ]
    ...
    def test_handle_real_estate_lead(
        self, mock_save, mock_twilio, mock_mistral, mock_get_property
    ):
        """Test the handle_real_estate_lead function."""
        # Mock the property details
        mock_get_property.return_value = {
            "title": "Attico a Milano",
            "price": 500000,
            "city": "Milano",
        }
