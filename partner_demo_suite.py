...
scenario(
    "IL VENDITORE (Acquisizione)", "Un potenziale venditore richiede una valutazione dal sito."
)
...
scenario(
    "IL COMPRATORE (Precision RAG)",
    "Un cliente cerca un immobile con requisiti specifici (Min 100mq, 3 locali).",
)
...
scenario(
    "LA CHIUSURA (Alternative & Takeover)",
    "L'immobile richiesto non è disponibile, l'AI propone alternative e poi interviene l'umano.",
)
