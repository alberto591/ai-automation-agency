...
def verify_full_flow():
    ...
    mock_ai.generate_response.return_value = "Ciao Mario, ho trovato un appartamento a Milano per te!"
    
    processor = LeadProcessor(mock_db, mock_ai, mock_msg, scorer)
    
    print("Processing message...")
    response = processor.process_lead("+39333000000", "Mario Rossi", "Cerco un appartamento a Milano")
