...
CREATE INDEX IF NOT EXISTS idx_validation_zone ON appraisal_validations(zone);
CREATE INDEX IF NOT EXISTS idx_validation_date ON appraisal_validations(appraisal_date DESC);
