...
def run_tuscany_tests():
    test_cases = [
        ...
        {"name": "Figline e Incisa Valdarno", "addr": "via S. Martino Altoreggi, 72, 50063 Figline e Incisa Valdarno FI"}
    ]
    ...
    for tc in test_cases:
        ...
        if tc['name'].upper() in result.upper() or (tc['name'] == "General Toscana" and "TOSCANA" in result.upper()):
