...
def search_agencies(city="Milano", pages=1):
    ...
    mock_data = [
        {"name": "Milano Elite Properties", "phone": "+393401111111", "address": "Via Dante 10", "city": city},
        {"name": "Vivere Meglio Real Estate", "phone": "+393402222222", "address": "Piazza Duomo 5", "city": city},
        {"name": "Global House Milano", "phone": "+393403333333", "address": "Corso Buenos Aires 12", "city": city},
    ]
...
def generate_outreach_csv(agencies, filename="outreach_targets.csv"):
    ...
    with open(filename, mode='w', newline='', encoding='utf-8') as f:
        ...
        for agency in agencies:
            ...
            message = f"Ciao {agency['name']}! Ho visto la vostra vetrina in {agency['address']}. " \
...
def main():
    ...
    parser.add_argument("--output", type=str, default="outreach_targets.csv", help="Output CSV filename")
