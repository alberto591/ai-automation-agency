from lead_manager import TIER1_TAKEOVER_KEYWORDS, TIER2_ALERT_KEYWORDS, fuzzy_keyword_match
...
def test_fuzzy_match_synonym():
    ...
    assert (
        fuzzy_keyword_match("Vorrei parlare con una persona reale", TIER1_TAKEOVER_KEYWORDS) is True
    )
